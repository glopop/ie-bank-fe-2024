          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th scope="col">Account Country</th> <!-- this is the country field added-->
            ...
            <tbody>
              <tr v-for="account in accounts" :key="account.id">
                ...
                <td>{{ account.country }}</td> <!--this is the country field added-->
                <td>
                  <span
  ...
  methods: {
    ...
    onSubmit(e) {
      ...
      const payload = {
        ...
        country: this.createAccountForm.country // add country
      };
    ...
    onSubmitUpdate(e) {
      ...
      const payload = {
        ...
        country: this.editAccountForm.country // add country here
      };
